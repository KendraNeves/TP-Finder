...
function GetMap() {
  ...
  var pipeline = atlas.service.MapsURL.newPipeline(
    new atlas.service.SubscriptionKeyCredential(atlas.getSubscriptionKey())
  );
  ...
  map.events.add("ready", function() {
    ...
    map.imageSprite
      .add("going-potty", "https://cdn.shopify.com/s/files/1/0251/2525/7269/files/tp-hunter-lg.png")
      .then(function() {
        ...
        map.layers.add(
          new atlas.layer.SymbolLayer(userLocation, null, {
            iconOptions: {
              image: "going-potty",
              anchor: "center",
              size: 0.5,
    ...
    map.imageSprite.add(
      "question-tp",
      "https://cdn.shopify.com/s/files/1/0251/2525/7269/files/question-tp.png"
    );
    ...
    map.imageSprite.add(
      "tp-full",
      "https://cdn.shopify.com/s/files/1/0251/2525/7269/files/tp-full.png"
    );
    ...
    map.imageSprite.add(
      "tp-half",
      "https://cdn.shopify.com/s/files/1/0251/2525/7269/files/tp-half.png"
    );
    ...
    map.imageSprite.add(
      "tp-empty",
      "https://cdn.shopify.com/s/files/1/0251/2525/7269/files/tp-empty.png"
    );
  ...
  async function parallelGeocode() {
    ...
    for (var i = 0; i < addresses.length; i++) {
      requests.push(
        geoURL.searchAddress(atlas.service.Aborter.timeout(10000), addresses[i], searchOptions)
      );
    }
    //HALF TP Create the request promises.
    for (var i = 0; i < addressesHalf.length; i++) {
      requestsHALF.push(
        geoURLHALF.searchAddress(
  ...
  function showPopup(e) {
    ...
    var html = `
       ...
       <div><a href=/members/${p.poi.store_ID}>Change store status</a></div>
     </div>`;
