...
module.exports = function(app) {
  ...
  app.get("/members", isAuthenticated, function(req, res) {
    res.render(path.join(__dirname, "../views/members"), {title: "members", storeID: null});
  });
  
  app.get("/members/:storeID", isAuthenticated, function(req, res) {
    res.render(path.join(__dirname, "../views/members"), {title: "members", storeID: req.params.storeID});
  });
